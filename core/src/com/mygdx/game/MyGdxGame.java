...
public class MyGdxGame extends ApplicationAdapter {
	...
	public void render() {
		...
		// отрисовка капелек. перебераем массив raindrops  и каждый объект из него
		...
		// создаём цикл для итерирования капли, т.е. будем отслеживать каждую созданную
		// каплю, и заставлять её падать вниз, в случае падения в ведро или за пределы
	...
	// dispose() - позволяет удалить еиспользуемые в игре объекты/предметы
	@Override
	public void dispose() {
		dropImage.dispose();
		bucketImage.dispose();
